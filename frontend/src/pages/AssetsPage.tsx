                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(190px, 1fr))', gap: 10 }}>
                    {filtered.map(asset => (
                        <div
                            ...
                            style={{ borderRadius: 12, overflow: 'hidden', aspectRatio: '1', border: '1px solid rgba(255,255,255,0.07)', cursor: 'pointer', position: 'relative', transition: 'transform 0.2s, border-color 0.2s' }}
                        >
                            <img src={asset.url} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                            <div className="asset-overlay" style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(0,0,0,0.85) 0%, transparent 55%)', opacity: 0, transition: 'opacity 0.2s', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', padding: 10 }}>
